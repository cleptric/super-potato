    ...
    <div class="max-w-7xl mx-auto py-3 sm:px-6 lg:px-8">
        <div class="relative h-[470px] px-4 py-5 bg-white shadow rounded-lg overflow-hidden sm:p-6 xl:h-[600px]">
            <div class="flex justify-end">
                ...
                <div
                    v-if="lowl.metar.wind_shear_runways"
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-red-800">
                                Windshear on Runway {{ lowl.metar.wind_shear_runways.join(' & ') }}
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    v-if="lowl.metar.wind_shear_all_runways"
                    class="rounded-md bg-red-50 py-4 px-6 ml-6"
                >
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
            ...
            <div class="absolute top-0 right-0 bottom-0 left-0 flex items-center justify-center">
                <div
                    ...
                    :class="{ 'bg-red-200 border-red-300': lowl.closed_runways.includes('08/26') }"
                >

                    <div
                        class="relative h-full flex items-center px-4 py-5 text-center text-2xl font-black"
                        :class="{ 'rounded-lg bg-blue-200': lowl.closed_runways.includes('08/26') === false && (lowl.atis.arrival_runway.includes('08') || lowl.atis.depature_runway.includes('08')) }"
                    >
                        <div
                            v-if="lowl.atis.arrival_runway.includes('08') && lowl.closed_runways.includes('08/26') === false"
                            class="absolute left-[-40px] h-6 w-6 transform rotate-90"
                        >
                            <i class="far fa-lg fa-arrow-to-top"></i>
                        </div>
                        <div
                            v-if="lowl.atis.depature_runway.includes('08') && lowl.closed_runways.includes('08/26') === false"
                    ...
                    <template v-else>
                        <div
                            v-if="lowl.metar.rvr['08'] !== undefined"
                            class="text-center text-xl font-bold"
                        >
                            {{ lowl.metar.rvr['08'] }}
                        </div>

                        <template v-if="!lowl.metar.is_variable && lowl.metar.mean_direction">
                        ...
                        <template v-else-if="lowl.metar.is_variable">
                            <div class="relative flex items-center justify-center text-blue-300">
                                <template v-if="lowl.metar.mean_speed >= 4">
                        ...
                        <div
                            v-if="lowl.metar.rvr[26] !== undefined"
                            class="text-center text-xl font-bold"
                        >
                            {{ lowl.metar.rvr[26] }}
                        </div>
                    ...
                    <div
                        class="relative h-full flex items-center px-4 py-5 text-center text-2xl font-black"
                        :class="{ 'rounded-lg bg-blue-200': lowl.closed_runways.includes('08/26') === false && (lowl.atis.arrival_runway.includes('26') || lowl.atis.depature_runway.includes('26')) }"
                    >
                        <div
                            v-if="lowl.atis.arrival_runway.includes('26') && lowl.closed_runways.includes('08/26') === false"
                            class="absolute right-[-40px] h-6 w-6 transform -rotate-90"
                        >
                            <i class="far fa-lg fa-arrow-to-top"></i>
                        </div>
                        <div
                            v-if="lowl.atis.depature_runway.includes('26') && lowl.closed_runways.includes('08/26') === false"
                            class="absolute left-[-40px] h-6 w-6 transform -rotate-90"
                        >
                            <i class="far fa-lg fa-arrow-up"></i>
                        </div>
    ...
    setup () {
        ...
        return {
            ...
            windArrow0826: computed(() => {
                return {
                    transform: `rotate(${store.getters.lowl.metar.mean_direction - -105}deg)`
                }
            }),
        }
    },
